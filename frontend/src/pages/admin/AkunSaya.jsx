      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg">
            ...
            <form className="space-y-6" onSubmit={handleProfileUpdate}>
              <div>
                ...
                <input type="text" id="name" name="name" defaultValue="Nama Admin" className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
              </div>
              <div>
                <label htmlFor="email" className="block text-lg font-semibold text-gray-700 mb-2">Alamat Email</label>
                <input type="email" id="email" name="email" defaultValue="admin@fashionpark.com" readOnly className="w-full p-3 border border-gray-300 rounded-lg bg-gray-100 cursor-not-allowed" />
              </div>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white p-8 rounded-2xl shadow-lg text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-800">Nama Admin</h3>
